...
@Entity(name = "TServiceWithMaxAndModify")
@Table(name = "TSERVICE_WITH_MAX_AND_MODIFY")
    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TServiceWithMaxAndModify)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final TServiceWithMaxAndModify that = ((TServiceWithMaxAndModify) object);
        {
            boolean lhsModify;
