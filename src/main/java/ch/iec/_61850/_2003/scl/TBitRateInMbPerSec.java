 ...
 *       &lt;attribute name="unit" use="required" type="{http://www.iec.ch/61850/2003/SCL}tSIUnitEnum" fixed="b/s" />
...
@Entity(name = "TBitRateInMbPerSec")
@Table(name = "TBIT_RATE_IN_MB_PER_SEC")
    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TBitRateInMbPerSec)) {
            return false;
        }
        if (this == object) {
            return true;
