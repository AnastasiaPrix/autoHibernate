...
@Entity(name = "TEquipmentContainer")
@Table(name = "TEQUIPMENT_CONTAINER")
    ...
    implements Equals, HashCode
{
     ...
     * 
     */
    @OneToMany(targetEntity = TPowerTransformer.class, cascade = {
        CascadeType.ALL
    })
    @JoinColumn(name = "POWER_TRANSFORMER_TEQUIPMENT_0")
     ...
     * 
     */
    public void setPowerTransformer(List<TPowerTransformer> powerTransformer) {
    ...
    @JoinColumn(name = "GENERAL_EQUIPMENT_TEQUIPMENT_0")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TEquipmentContainer)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final TEquipmentContainer that = ((TEquipmentContainer) object);
        {
            List<TPowerTransformer> lhsPowerTransformer;
            lhsPowerTransformer = (((this.powerTransformer!= null)&&(!this.powerTransformer.isEmpty()))?this.getPowerTransformer():null);
            List<TPowerTransformer> rhsPowerTransformer;
            rhsPowerTransformer = (((that.powerTransformer!= null)&&(!that.powerTransformer.isEmpty()))?that.getPowerTransformer():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "powerTransformer", lhsPowerTransformer), LocatorUtils.property(thatLocator, "powerTransformer", rhsPowerTransformer), lhsPowerTransformer, rhsPowerTransformer)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<TPowerTransformer> thePowerTransformer;
            thePowerTransformer = (((this.powerTransformer!= null)&&(!this.powerTransformer.isEmpty()))?this.getPowerTransformer():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "powerTransformer", thePowerTransformer), currentHashCode, thePowerTransformer);
        }
        {
