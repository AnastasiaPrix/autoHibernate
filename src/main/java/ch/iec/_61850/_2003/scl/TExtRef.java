 ...
 *       &lt;attGroup ref="{http://www.iec.ch/61850/2003/SCL}agDORef"/>
    ...
    implements Equals, HashCode
{
    ...
    protected Long hjid;
    protected transient List<TExtRefLnClassItem> lnClassItems;
     ...
     */
    @Basic
    @Column(name = "INT_ADDR", length = 255)
    ...
    @OneToMany(targetEntity = TExtRef.TExtRefLnClassItem.class, cascade = {
        CascadeType.ALL
    })
    @JoinColumn(name = "LN_CLASS_ITEMS_TEXT_REF_HJID")
    public List<TExtRefLnClassItem> getLnClassItems() {
        if (this.lnClassItems == null) {
            this.lnClassItems = new ArrayList<TExtRefLnClassItem>();
        }
        if (ItemUtils.shouldBeWrapped(this.lnClass)) {
            this.lnClass = ItemUtils.wrap(this.lnClass, this.lnClassItems, TExtRef.TExtRefLnClassItem.class);
        }
        return this.lnClassItems;
    }

    public void setLnClassItems(List<TExtRefLnClassItem> value) {
        this.lnClass = null;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TExtRef)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TExtRef that = ((TExtRef) object);
        {
            String lhsDaName;
        ...
        {
            String lhsIntAddr;
            lhsIntAddr = this.getIntAddr();
            String rhsIntAddr;
            rhsIntAddr = that.getIntAddr();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "intAddr", lhsIntAddr), LocatorUtils.property(thatLocator, "intAddr", rhsIntAddr), lhsIntAddr, rhsIntAddr)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            String theIntAddr;
            theIntAddr = this.getIntAddr();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "intAddr", theIntAddr), currentHashCode, theIntAddr);
        }
        {
            String theDoName;
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @Entity(name = "TExtRef$TExtRefLnClassItem")
    @Table(name = "TEXT_REF_LN_CLASS_ITEM")
    @Inheritance(strategy = InheritanceType.JOINED)
    public static class TExtRefLnClassItem
